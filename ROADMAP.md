...
### Marca ludoc (via BrandDocs)
- Definir: o que é ludoc (PJ de software/consultoria/produto), paleta de cores, fonte
- Criar template `.docx` seed ou usar documento existente
- Clonar `ferdinandobons/brand-docs` e rodar `extract → verify → generate`
